...
/**
 * Base adapter for the VirtualView interface providing empty (no-op) implementations.
 * Used on the server side to simplify RemoteView implementations by letting subclasses override only the callbacks they need.
 *
