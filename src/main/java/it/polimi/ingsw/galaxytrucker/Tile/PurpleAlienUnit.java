...
/**
 *  class for the housing unit designate to host purple aliens or humans
...
public class PurpleAlienUnit extends Tile {
     ...
     * @param d
     */
    public PurpleAlienUnit(int a,int b,int c,int d) {
        corners[0]=a;
        corners[1]=b;
        corners[2]=c;
        corners[3]=d;
    ...
    /**
     * the method add to the housing unit a human or a purple alien
    ...
    public void addHuman(Humans u) throws FullHousingList, IllegalArgumentException {
        if(TotHumans.size() == max){
            ...
            throw new IllegalArgumentException("Brown aliens can not be place here");
        }
        TotHumans.add(u);
    }
    /**
