...
public class TUIView implements View {
    ...
    @Override
    public int askIndexBlocking() throws IOException {
        while (true) {
            String line = console.readLine();
            try { return Integer.parseInt(line.trim()) - 1; }
            catch (NumberFormatException e) { reportError("Insert index:"); }
        }
    }
    ...
    public int[] askCoordinateBlocking() throws IOException {
        ...
        while (true) {
            ...
            String line = console.readLine();
            try {
                coord[0] = Integer.parseInt(line.trim()) - 5;
                if (coord[0] >= 0 && coord[0] < 5) break;
            } catch (NumberFormatException ignored) { }
            reportError("Invalid input. Please enter a valid number.");
        }
        ...
        while (true) {
            ...
            String line = console.readLine();
            try {
                coord[1] = Integer.parseInt(line.trim()) - 4;
                if (coord[1] >= 0 && coord[1] < 7) break;
            } catch (NumberFormatException ignored) { }
            reportError("Invalid input. Please enter a valid number.");
        }
        return coord;
    ...
    public boolean askBlocking(String message) throws IOException {
        ...
        while (true) {
            String l = console.readLine().trim().toLowerCase();
            if (l.equals("yes")) return true;
            if (l.equals("no"))  return false;
            reportError("Type yes or no.");
        }
    }
    ...
    public String choosePlayerBlocking() throws IOException {
        while (true) {
            ...
            reportError("Please enter a valid nickname.");
        }
    }
